...
async function loadItems() {
    const items = await _api.getItems();
    itemList.innerHTML = "";
    items.forEach((item)=>{
        const itemElement = itemTemplate.content.cloneNode(true);
        itemElement.querySelector("[data-item-name]").textContent = item.name;
        itemElement.querySelector("[data-item-price]").textContent = `$${item.price}`;
...
},{"./api":"kWXJ4"}],"kWXJ4":[function(require,module,exports) {
...
},{}]},["hlItI","8fvzf"], "8fvzf", "parcelRequiree8ef")
